...
M.config = function()
  ...
  vim.api.nvim_set_keymap("i", "<Plug>compe_confirm", [[compe#confirm('<CR>')]], { expr = true })
  vim.api.nvim_set_keymap("i", "<CR>", "<C-G>u<Plug>compe_confirm", { expr = true })
